...
import ru.rsue.Karnaukhova.activity.AddItem;
import ru.rsue.Karnaukhova.adapter.ItemAdapter;
...
public class ProductsHost extends Fragment {
    ...
    private void updateUI() {
        ItemRepository itemRepository = ItemRepository.get(getContext());
        ...
        if (itemAdapter == null) {
            items.addAll(itemRepository.getItems());
